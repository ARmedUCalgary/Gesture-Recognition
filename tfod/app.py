...
def main():
    ...
    hands = mp_hands.Hands(
        ...
        # set max hands to whatever number of hands you want to track
        max_num_hands=2,
    ...
    while True:
        ...
        if not ret:
            break
        image = cv.flip(image, 1)  # Mirror display, dont mess with this, left-hand right-hand set up for flipped
